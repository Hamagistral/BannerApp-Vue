<template>
  <div>
    <template>
      <v-form class="primary pa-8 lighten-4" ref="form" v-model="valid" lazy-validation>
        <v-btn color="primary" class="mr-4" @click="addImage()">
          Fermer
        </v-btn>
        ...
        <v-btn color="success" class="mr-4" @click="addImage()">
          Enregistrer
        </v-btn>
